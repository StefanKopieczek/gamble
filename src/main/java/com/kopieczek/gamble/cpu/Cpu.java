...
public class Cpu {
    ...
    private static Map<Integer, Function<Cpu, Integer>> loadOperations() {
        ...
        m.put(0x07, cpu -> Operations.rotateALeftOntoCarry(cpu));
        m.put(0x17, cpu -> Operations.rotateALeftThroughCarry(cpu));
        m.put(0x0f, cpu -> Operations.rotateARightOntoCarry(cpu));
        m.put(0x1f, cpu -> Operations.rotateARightThroughCarry(cpu));
    ...
    private static Map<Integer, Function<Cpu, Integer>> loadExtendedOperations() {
        ImmutableMap.Builder<Integer, Function<Cpu, Integer>> m = ImmutableMap.builder();
        m.put(0x00, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.B));
        m.put(0x01, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.C));
        m.put(0x02, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.D));
        m.put(0x03, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.E));
        m.put(0x04, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.H));
        m.put(0x05, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.L));
        m.put(0x06, cpu -> Operations.rotateLeftOntoCarry(cpu, Pointer.of(Word.Register.HL)));
        m.put(0x07, cpu -> Operations.rotateLeftOntoCarry(cpu, Byte.Register.A));
        m.put(0x08, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.B));
        m.put(0x09, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.C));
        m.put(0x0a, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.D));
        m.put(0x0b, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.E));
        m.put(0x0c, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.H));
        m.put(0x0d, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.L));
        m.put(0x0e, cpu -> Operations.rotateRightOntoCarry(cpu, Pointer.of(Word.Register.HL)));
        m.put(0x0f, cpu -> Operations.rotateRightOntoCarry(cpu, Byte.Register.A));
        m.put(0x10, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.B));
        m.put(0x11, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.C));
        m.put(0x12, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.D));
        m.put(0x13, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.E));
        m.put(0x14, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.H));
        m.put(0x15, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.L));
        m.put(0x16, cpu -> Operations.rotateLeftThroughCarry(cpu, Pointer.of(Word.Register.HL)));
        m.put(0x17, cpu -> Operations.rotateLeftThroughCarry(cpu, Byte.Register.A));
        m.put(0x18, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.B));
        m.put(0x19, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.C));
        m.put(0x1a, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.D));
        m.put(0x1b, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.E));
        m.put(0x1c, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.H));
        m.put(0x1d, cpu -> Operations.rotateRightThroughCarry(cpu, Byte.Register.L));
        m.put(0x1e, cpu -> Operations.rotateRightThroughCarry(cpu, Pointer.of(Word.Register.HL)));
