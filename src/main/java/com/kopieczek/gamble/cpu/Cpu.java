...
public class Cpu {
    ...
    private static Map<Integer, Operation> loadOperations() {
        ...
        m.put(0x46, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.B));
        ...
        m.put(0x4e, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.C));
        ...
        m.put(0x56, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.D));
        ...
        m.put(0x5e, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.E));
        ...
        m.put(0x66, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.H));
        ...
        m.put(0x6e, Operations.copyValue(IndirectAddress.from(Register.H, Register.L), Register.L));
        m.put(0x70, Operations.copyValue(Register.B, IndirectAddress.from(Register.H, Register.L)));
