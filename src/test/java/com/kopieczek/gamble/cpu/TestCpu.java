...
public class TestCpu {
    ...
    public void test_ldd_hl_a() {
        ...
        assertEquals(0x01, cpu.readByte(0xabcd));
        assertEquals(0xab, cpu.readByte(Register.H));
        assertEquals(0xcc, cpu.readByte(Register.L));
    }
    ...
    public void test_ldi_a_hl() {
        ...
        assertEquals(0xcd, cpu.readByte(Register.A));
        assertEquals(0xef, cpu.readByte(Register.H));
        assertEquals(0x57, cpu.readByte(Register.L));
    }
    ...
    public void test_ldi_hl_a() {
        ...
        assertEquals(0x01, cpu.readByte(0xabcd));
        assertEquals(0xab, cpu.readByte(Register.H));
        assertEquals(0xce, cpu.readByte(Register.L));
    }
